...
Route::get('/users', [\App\Http\Controllers\AdminPannelController::class, 'adminPannelView'])->middleware(['auth'])->name('ajustes');
...
Route::get('/data', [\App\Http\Controllers\DataController::class,'userInfo'] )->middleware(['auth'])->middleware('can:isAdmin')->name('personalInfo');
