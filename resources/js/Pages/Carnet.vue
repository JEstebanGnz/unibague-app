...
<template>
    <div
        class="w-full sm:max-h-screen sm:w-1/4 flex flex-col min-h-screen overflow-hidden mx-auto bg-unibague-blue bg-opacity-3 rounded-xl mb-2 relative">
        <div>
        ...
        <div class=" my-8 flex flex-col mx-auto font-bold text-lg justify-center text-center">
            <h3>{{ role }}</h3>
